...
/// @ingroup detour
class __declspec(dllexport) dtPolyQuery
{
public:
	virtual ~dtPolyQuery();
...
/// @ingroup detour
__declspec(dllexport) dtNavMeshQuery* dtAllocNavMeshQuery();

/// Frees the specified query object using the Detour allocator.
///  @param[in]		query		A query object allocated using #dtAllocNavMeshQuery
/// @ingroup detour
__declspec(dllexport) void dtFreeNavMeshQuery(dtNavMeshQuery* query);
