...
__declspec(dllexport) bool dtCreateNavMeshData(dtNavMeshCreateParams* params, unsigned char** outData, int* outDataSize);

/// Swaps the endianness of the tile data's header (#dtMeshHeader).
///  @param[in,out]	data		The tile data array.
///  @param[in]		dataSize	The size of the data array.
__declspec(dllexport) bool dtNavMeshHeaderSwapEndian(unsigned char* data, const int dataSize);

/// Swaps endianness of the tile data.
///  @param[in,out]	data		The tile data array.
///  @param[in]		dataSize	The size of the data array.
__declspec(dllexport) bool dtNavMeshDataSwapEndian(unsigned char* data, const int dataSize);
