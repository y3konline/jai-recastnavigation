...
__declspec(dllexport) void rcFreeHeightField(rcHeightfield* heightfield);
...
__declspec(dllexport) void rcFreeCompactHeightfield(rcCompactHeightfield* compactHeightfield);
...
__declspec(dllexport) void rcFreeHeightfieldLayerSet(rcHeightfieldLayerSet* layerSet);
...
__declspec(dllexport) void rcFreeContourSet(rcContourSet* contourSet);
...
/// @ingroup recast
/// @see rcAllocPolyMesh
__declspec(dllexport) void rcFreePolyMesh(rcPolyMesh* polyMesh);
...
__declspec(dllexport) void rcFreePolyMeshDetail(rcPolyMeshDetail* detailMesh);
...
__declspec(dllexport) float rcSqrt(float x);
...
__declspec(dllexport) inline void rcVcross(float* dest, const float* v1, const float* v2)
{
...
__declspec(dllexport) inline float rcVdot(const float* v1, const float* v2)
{
...
__declspec(dllexport) inline void rcVmad(float* dest, const float* v1, const float* v2, const float s)
{
	dest[0] = v1[0]+v2[0]*s;
	dest[1] = v1[1]+v2[1]*s;
	dest[2] = v1[2]+v2[2]*s;
...
__declspec(dllexport) inline void rcVadd(float* dest, const float* v1, const float* v2)
{
	dest[0] = v1[0]+v2[0];
	dest[1] = v1[1]+v2[1];
	dest[2] = v1[2]+v2[2];
...
__declspec(dllexport) inline void rcVsub(float* dest, const float* v1, const float* v2)
{
	dest[0] = v1[0]-v2[0];
	dest[1] = v1[1]-v2[1];
	dest[2] = v1[2]-v2[2];
...
__declspec(dllexport) inline void rcVmin(float* mn, const float* v)
{
	mn[0] = rcMin(mn[0], v[0]);
	mn[1] = rcMin(mn[1], v[1]);
	mn[2] = rcMin(mn[2], v[2]);
...
/// @param[in]		v	A vector. [(x, y, z)]
__declspec(dllexport) inline void rcVmax(float* mx, const float* v)
{
	mx[0] = rcMax(mx[0], v[0]);
	mx[1] = rcMax(mx[1], v[1]);
	mx[2] = rcMax(mx[2], v[2]);
...
__declspec(dllexport) inline void rcVcopy(float* dest, const float* v)
{
	dest[0] = v[0];
	dest[1] = v[1];
	dest[2] = v[2];
...
__declspec(dllexport) inline float rcVdist(const float* v1, const float* v2)
{
	float dx = v2[0] - v1[0];
	float dy = v2[1] - v1[1];
	float dz = v2[2] - v1[2];
...
__declspec(dllexport) inline float rcVdistSqr(const float* v1, const float* v2)
{
	float dx = v2[0] - v1[0];
	float dy = v2[1] - v1[1];
	float dz = v2[2] - v1[2];
...
__declspec(dllexport) inline void rcVnormalize(float* v)
{
...
__declspec(dllexport) void rcCalcBounds(const float* verts, int numVerts, float* minBounds, float* maxBounds);
...
__declspec(dllexport) void rcCalcGridSize(const float* minBounds, const float* maxBounds, float cellSize, int* sizeX, int* sizeZ);
...
__declspec(dllexport) bool rcCreateHeightfield(rcContext* context, rcHeightfield& heightfield, int sizeX, int sizeZ,
...
__declspec(dllexport) void rcMarkWalkableTriangles(rcContext* context, float walkableSlopeAngle, const float* verts, int numVerts,
...
/// @param[in]		numTris				The number of triangles.
/// @param[out]		triAreaIDs			The triangle area ids. [Length: >= @p nt]
__declspec(dllexport) void rcClearUnwalkableTriangles(rcContext* context, float walkableSlopeAngle, const float* verts, int numVerts,
								const int* tris, int numTris, unsigned char* triAreaIDs);
...
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcAddSpan(rcContext* context, rcHeightfield& heightfield,
	           int x, int z,
...
/// 									[Limit: >= 0] [Units: vx]
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcRasterizeTriangle(rcContext* context,
...
///										[Limit: >= 0] [Units: vx]
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcRasterizeTriangles(rcContext* context,
...
__declspec(dllexport) void rcFilterLowHangingWalkableObstacles(rcContext* context, int walkableClimb, rcHeightfield& heightfield);
...
/// 								[Limit: >=0] [Units: vx]
/// @param[in,out]	heightfield			A fully built heightfield.  (All spans have been added.)
__declspec(dllexport) void rcFilterLedgeSpans(rcContext* context, int walkableHeight, int walkableClimb, rcHeightfield& heightfield);
...
/// 								be considered walkable. [Limit: >= 3] [Units: vx]
/// @param[in,out]	heightfield		A fully built heightfield.  (All spans have been added.)
__declspec(dllexport) void rcFilterWalkableLowHeightSpans(rcContext* context, int walkableHeight, rcHeightfield& heightfield);
...
__declspec(dllexport) int rcGetHeightFieldSpanCount(rcContext* context, const rcHeightfield& heightfield);
...
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcBuildCompactHeightfield(rcContext* context, int walkableHeight, int walkableClimb,
...
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcErodeWalkableArea(rcContext* context, int erosionRadius, rcCompactHeightfield& compactHeightfield);
...
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcMedianFilterWalkableArea(rcContext* context, rcCompactHeightfield& compactHeightfield);
...
/// @param[in,out]	compactHeightfield	A populated compact heightfield.
__declspec(dllexport) void rcMarkBoxArea(rcContext* context, const float* boxMinBounds, const float* boxMaxBounds, unsigned char areaId,
...
/// @param[in]		areaId				The area id to apply. [Limit: <= #RC_WALKABLE_AREA]
/// @param[in,out]	compactHeightfield	A populated compact heightfield.
__declspec(dllexport) void rcMarkConvexPolyArea(rcContext* context, const float* verts, int numVerts,
...
__declspec(dllexport) int rcOffsetPoly(const float* verts, int numVerts, float offset, float* outVerts, int maxOutVerts);
...
/// @param[in]		areaId				The area id to apply. [Limit: <= #RC_WALKABLE_AREA]
/// @param[in,out]	compactHeightfield	A populated compact heightfield.
__declspec(dllexport) void rcMarkCylinderArea(rcContext* context, const float* position, float radius, float height,
...
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcBuildDistanceField(rcContext* ctx, rcCompactHeightfield& chf);
...
/// 								be merged with larger regions. [Limit: >=0] [Units: vx]
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcBuildRegions(rcContext* ctx, rcCompactHeightfield& chf, int borderSize, int minRegionArea, int mergeRegionArea);
...
///  								[Limit: >=0] [Units: vx].
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcBuildLayerRegions(rcContext* ctx, rcCompactHeightfield& chf, int borderSize, int minRegionArea);
...
///  								be merged with larger regions. [Limit: >=0] [Units: vx]
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcBuildRegionsMonotone(rcContext* ctx, rcCompactHeightfield& chf,
...
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcBuildHeightfieldLayers(rcContext* ctx, const rcCompactHeightfield& chf,
...
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcBuildContours(rcContext* ctx, const rcCompactHeightfield& chf,
...
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcBuildPolyMesh(rcContext* ctx, const rcContourSet& cset, const int nvp, rcPolyMesh& mesh);
...
///  @returns True if the operation completed successfully.
__declspec(dllexport) bool rcMergePolyMeshes(rcContext* ctx, rcPolyMesh** meshes, const int nmeshes, rcPolyMesh& mesh);
...
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcBuildPolyMeshDetail(rcContext* ctx, const rcPolyMesh& mesh, const rcCompactHeightfield& chf,
...
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcCopyPolyMesh(rcContext* ctx, const rcPolyMesh& src, rcPolyMesh& dst);
...
/// @returns True if the operation completed successfully.
__declspec(dllexport) bool rcMergePolyMeshDetails(rcContext* ctx, rcPolyMeshDetail** meshes, const int nmeshes, rcPolyMeshDetail& mesh);
